...
designation=driver.find_element(By.CLASS_NAME,'nav-left')
...
# scraping job name from the given page
name_tags=driver.find_elements(By.XPATH,'//div[@class="_2WkVRV"]')
for i in name_tags[0:10]:
    name=i.text
    brand_name.append(name)

# scraping job Born-Dead from the given page
Born_tags=driver.find_elements(By.XPATH,'//a[@class="IRpwTa"]')
for i in Born_tags[0:10]:
    Born=i.text
    Born_Dead.append(Born)
    
# scraping job term of office from the given page
Term_tags=driver.find_elements(By.XPATH,'//div[@class="_30jeq3"]')
for i in Term_tags[0:10]:
    Term=i.text
    Term_of_office.append(Term)
    
# scraping job remarks from the given page
remarks_tags=driver.find_elements(By.XPATH,'//a[@class="IRpwTa"]')
